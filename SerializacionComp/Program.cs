    ...
    class MainClass
    {
        public static void Main(string[] args)
        {
            ...
            if (opcion == 1)
            {
                ...
                Console.WriteLine("Dame el cilindraje");
                cilindros = Convert.ToInt32(Console.ReadLine());
                Console.WriteLine("Dame el horse power");
                ...
                //seleccionamos e lformateador type cast importante de cada uno de los objetos
            ...
            if (opcion == 2)
            {
                ...
                //seleccionamos el formateador sadsad 
                XmlSerializer formateador = new XmlSerializer(typeof(CAuto),new Type[] {typeof(CMotor) });
